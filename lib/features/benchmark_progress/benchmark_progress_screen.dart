...
class BenchmarkProgressScreen extends StatefulWidget {
  ...
  @override
  State<BenchmarkProgressScreen> createState() =>
      _BenchmarkProgressScreenState();
}
      ...
      if (mounted) {
        await Navigator.of(context).pushReplacement(
          MaterialPageRoute<void>(
              builder: (_) =>
                  BenchmarkResultsScreen(controller: widget.controller)),
        );
      }
    });
  }
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                    'Average latency: ${(progress?.averageLatencyMs ?? 0).toStringAsFixed(2)} ms'),
